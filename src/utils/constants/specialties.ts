...
export const SPECIALTY_COLORS: Record<Specialty, string> = {
  ...
  'Jeu de Soirée': 'bg-yellow-500/20 text-yellow-500 border-yellow-500',
  Coopératif: 'bg-orange-500/20 text-orange-500 border-orange-500',
  Ambiance: 'bg-red-500/20 text-red-500 border-red-500',
  'Construction de Deck': 'bg-gray-500/20 text-gray-400 border-gray-400',
  'Héritage': 'bg-amber-700/20 text-amber-600 border-amber-600',
